      ...
      <div className="w-full">
        ...
        <div className="relative">
          <input
            ...
            autoComplete="off"
            className={`w-full rounded-xl bg-bg-box p-4 pr-[50px] text-base outline-none transition-all placeholder:text-text-placeholder focus:bg-bg-box-hover focus:ring-2 focus:ring-primary/10 ${
